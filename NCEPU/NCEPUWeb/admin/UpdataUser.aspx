<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdataUser.aspx.cs" Inherits="NCEPUWeb.Admin.UpdataUser" %>
            ...
            <div id="sidebar">
                <div id="sidebar-wrapper">
                    ...
                    <ul id="main-nav">
                        ...
                        <li id="UpdataUserPag" runat="server"><a href="UpdataUser.aspx" class="nav-top-item no-submenu current">密码修改 </a>
                        </li>
                ...
                <div class="content-box">
                    ...
                    <div class="content-box-header">
                        <ul class="content-box-tabs">
                            <li><a href="#tab1" class="default-tab">修改密码</a></li>
                        </ul>
                        <div class="clear">
                        </div>
                    </div>
                        ...
                        <div class="tab-content default-tab" id="tab1">
                            <fieldset>
                                ...
                                <p>
                                    <label>
                                        用户名</label>
                                    <asp:TextBox ID="nameText" runat="server" ReadOnly="true" CssClass="text-input  medium-input "></asp:TextBox>
                                ...
                                <p>
                                    <label>
                                        旧密码</label>
                                    <asp:TextBox ID="oldPasswordText" runat="server" TextMode="Password" CssClass=" text-input  medium-input "></asp:TextBox>
                                ...
                                <p>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="密码！"
                                        Text="*" ControlToValidate="passwordText" ValidationGroup="news"></asp:RequiredFieldValidator>
                                    <br />
                                </p>
                                <p>
