<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateIntrodution.aspx.cs"
    Inherits="NCEPUWeb.Admin.UpdateIntrodution" %>
            ...
            <div id="sidebar">
                <div id="sidebar-wrapper">
                    ...
                    <ul id="main-nav">
                        ...
                        <li id="UpdateIntrodutionPad"  runat="server"><a href="UpdateIntrodution.aspx" class="nav-top-item  no-submenu current">
                            简介修改 </a></li>
                    </ul>
                    <!-- End #main-nav -->
                </div>
                ...
                <div class="content-box">
                    ...
                    <div class="content-box-header">
                        <ul class="content-box-tabs">
                            <li><a href="#tab1" class="default-tab">修改学校简介</a></li>
                        </ul>
                        <div class="clear">
                        </div>
                    </div>
                        ...
                        <div class="tab-content default-tab" id="tab1">
                            <fieldset>
                                ...
                                <p>
                                    <label>
                                        简介内容</label>
                                         <textarea rows="40" cols="50" id="newsContentCKE1" runat="server"></textarea>
                         ...
                         rows="15"></textarea>-->
                                ...
                                <p>
                                    <asp:Button ID="Button1" runat="server" Text="修改" CssClass=" button " OnClick="Button1_Click" OnClientClick="return confirm('确定修改？')"
